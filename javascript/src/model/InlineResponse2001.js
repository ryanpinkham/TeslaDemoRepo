...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TeslaModelSApi_.InlineResponse2001 = factory(root.TeslaModelSApi_.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('shift_state')) {
        obj['shift_state'] = ApiClient.convertToType(data['shift_state'], 'String');
      }
  ...
  /**
   * @member {String} shift_state
   */
  exports.prototype['shift_state'] = undefined;
  /**
   * @member {Number} speed
   */
